...
public interface IIdentityService
{
    ...
    Task<OperationResult<User>> CreateUserAsync(string displayName, string email, string password, string platformRole, bool isActive, bool mustChangePassword, CancellationToken cancellationToken = default);
    Task<OperationResult<User>> CreateBootstrapAdminAsync(string tenantId, string displayName, string email, string password, CancellationToken cancellationToken = default);
