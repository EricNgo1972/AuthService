...
public interface INotificationService
{
    ...
    Task SendPasswordResetAsync(User user, string tenantId, string tenantName, string resetToken, string resetUrl, DateTimeOffset expiresAtUtc, CancellationToken cancellationToken = default);
}
